...
@interface GAPhotoAlbumManger ()
@property(nonatomic, strong) ALAssetsLibrary *assetsLibrary;

@end

@implementation GAPhotoAlbumManger

static GAPhotoAlbumManger* _sharePhotoAlbumManger;
+ (instancetype)sharePhotoAlbumManger{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharePhotoAlbumManger = [[GAPhotoAlbumManger alloc] init];
    });
